...
const CartMobileComponent: React.FC<CartComponentProps> = ({
  venue,
  onClose,
  cartItems,
}) => {
  ...
  return (
    <>
      <div className="hidden md:flex h-[64px] p-4 w-full items-center bg-[#F8F9FA]">
        <p className="text-[18px] font-[500] text-[#464646]">Basket</p>
      </div>
      ...
      <div className="w-full flex flex-col gap-2 ">
        {cartItems.length > 0 ? (
          ...
          <div className="p-4">
            <p className="text-center text-[#464646]">Your basket is empty!</p>
          </div>
        )}
      </div>
