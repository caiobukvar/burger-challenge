...
import { CloseIconProps } from "@/types/types";
import { useDispatch } from "react-redux";

const CloseIcon: React.FC<CloseIconProps> = ({ color }) => {
  ...
  return (
    <button
      className="absolute top-10 right-4 cursor-pointer w-7 h-7 rounded-full bg-white"
